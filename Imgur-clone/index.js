...
async function main() {
  ...
  let items = await fetch(`https://api.imgur.com/3/gallery/t/${text}/top/all`, {
    method: "GET",
    headers: headersList,
  });
...
async function getImg() {
  ...
  let d = await fetch(
    `https://api.imgur.com/3/gallery/top/viral/${page}/month?showViral=true&mature=true&album_previews=true`,
    {
      method: "GET",
      headers: headersList,
    }
